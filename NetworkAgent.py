...
from agents.windows import Network as WindowsNetworkAgent
from agents.linux import Network as LinuxNetworkAgent
import ConfigParser
import platform
import uuid
...
if __name__ == "__main__":
    try:
        ...
        if opstr == 'windows':
            myNetwork = WindowsNetworkAgent.Network()
        elif opstr == 'linux':
            myNetwork = LinuxNetworkAgent.Network()
        else:
        ...
        myagent = AgentRunner(rabbitmq_url, rabbitmq_port,
                            ...
                            myNetwork.getNetworkAgent, 'Network', guid, refresh_rate)
        myagent.start()
