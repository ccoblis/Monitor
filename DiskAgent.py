...
from agents.windows import Disk as WindowsDiskAgent
from agents.linux import Disk as LinuxDiskAgent
import ConfigParser
import platform
import uuid
...
if __name__ == "__main__":
    try:
        ...
        if opstr == 'windows':
            mydisk = WindowsDiskAgent.Disk()
        elif opstr == 'linux':
            mydisk = LinuxDiskAgent.Disk()
        else:
        ...
        myagent = AgentRunner(rabbitmq_url, rabbitmq_port,
                            ...
                            mydisk.getDiskAgent, 'Disk', guid, refresh_rate)
        myagent.start()
